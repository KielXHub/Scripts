...
MakeNotifi({
  Title = "Kiel X Hub",
  Text = "Thanks For Using My Scripts",
  Time = 5
})
...
local Stats = MakeTab({Name = "Stats"})
local Teleport = MakeTab({Name = "Teleport"})
local ESP_Raid = MakeTab({Name = "ESP_Raid"})
local SeaEvent = MakeTab({Name = "SeaEvent"})
local Fruit = MakeTab({Name = "Fruit"})
local Shop = MakeTab({Name = "Shop"})
local Setting = MakeTab({Name = "Setting"})
----------
Info:AddSeperator("x2N HUB")
Info:UserMinhTien()
...
spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "Kiel X" then
...
Info:AddSeperator("🧑‍💻 Developer 🧑‍💻")
Info:AddLabel("Owner: Nguyen Minh Tien (Tien Tiny)")
Info:AddSeperator("Social Network")
Info:AddButton('Discord Sever', function()
